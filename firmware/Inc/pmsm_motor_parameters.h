...
#define MOTOR_VOLTAGE_CONSTANT  4.9 /*!< Volts RMS ph-ph /kRPM */
#define MOTOR_MAX_SPEED_RPM     3120 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       9.925

#define ID_DEMAG_A              -9.925 /*!< Demagnetization current */
