...
#define MAX_APPLICATION_SPEED_RPM           3120 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT               3151
#define PID_TORQUE_KI_DEFAULT               3151
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3151
#define PID_FLUX_KI_DEFAULT                 3151
...
#define PID_SPEED_KP_DEFAULT                2986/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                69/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define IQMAX_A                             9.925

/* Default settings */
#define DEFAULT_CONTROL_MODE                MCM_SPEED_MODE
#define DEFAULT_TARGET_SPEED_RPM            1123
...
#define PHASE1_FINAL_CURRENT_A              9.925

/* Phase 2 */
#define PHASE2_DURATION                     2496 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1248*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              9.925

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1248*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              9.925

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (1248*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              9.925

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1248*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              9.925
...
#define OBS_MINIMUM_SPEED_RPM               1123
